...
fun main() {
    ...
    downloader.download("16385").writeToFile(resourceFile("file_converter_tests/anime_season/season/unknown.html"))
    downloader.download("8504").writeToFile(resourceFile("file_converter_tests/anime_season/season/year_only.html"))
    ...
    downloader.download("16385").writeToFile(resourceFile("file_converter_tests/anime_season/year_of_premiere/unknown.html"))
    ...
    downloader.download("13631").writeToFile(resourceFile("file_converter_tests/duration/episodes_and_duration_unknown.html"))
    downloader.download("16205").writeToFile(resourceFile("file_converter_tests/duration/episodes_known_duration_unknown.html"))
    ...
    downloader.download("13631").writeToFile(resourceFile("file_converter_tests/episodes/unknown.html"))

    downloader.download("16508").writeToFile(resourceFile("file_converter_tests/picture_and_thumbnail/neither_picture_nor_thumbnail.html"))
    ...
    downloader.download("15908").writeToFile(resourceFile("file_converter_tests/status/ongoing.html"))
    ...
    downloader.download("15727").writeToFile(resourceFile("file_converter_tests/tags/no_tags.html"))
    ...
    downloader.download("16097").writeToFile(resourceFile("file_converter_tests/type/unknown.html"))
